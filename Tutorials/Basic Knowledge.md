...
<ul>
<li>On the top right you have the option to select several perferences: <img src="https://i.imgur.com/CAjoKeQ.png" alt=""><br>
...
<li>Another very useful feature is <strong>Visualize References</strong> (right click context menu). This will show you a graph of all assets connected to the selected one. <img src="https://i.imgur.com/nAvFP28.png" alt=""><br>
